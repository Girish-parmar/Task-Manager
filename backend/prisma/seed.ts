...
async function main() {
  ...
  const [admin, alice, bob, carla, dmitri, elena, frank] = await Promise.all([
    prisma.worker.create({
      data: {
        ...
        location: "New York",
        tags: { create: ["Management"].map((tag) => ({ tag })) },
    ...
    prisma.worker.create({
      data: {
        ...
        type: WorkerType.INTERNAL,
        location: "New York",
        tags: { create: ["IT", "Tier2", "Networking"].map((tag) => ({ tag })) },
    ...
    prisma.worker.create({
      data: {
        ...
        type: WorkerType.INTERNAL,
        location: "New York",
        tags: { create: ["IT", "Tier1"].map((tag) => ({ tag })) },
        availableCapacity: 5,
      },
    }),
    prisma.worker.create({
      data: {
        ...
        location: "Chicago",
        tags: { create: ["Plumbing", "Tier1"].map((tag) => ({ tag })) },
        availableCapacity: 8,
      },
    }),
    prisma.worker.create({
      data: {
        ...
        type: WorkerType.EXTERNAL,
        location: "Chicago",
        tags: { create: ["Plumbing", "Electrical", "Tier2"].map((tag) => ({ tag })) },
    ...
    prisma.worker.create({
      data: {
        ...
        type: WorkerType.INTERNAL,
        location: "Austin",
        tags: { create: ["IT", "Tier1", "Support"].map((tag) => ({ tag })) },
        availableCapacity: 3,
      },
    }),
    prisma.worker.create({
      data: {
        ...
        type: WorkerType.EXTERNAL,
        location: "Austin",
        tags: { create: ["Electrical", "Tier2"].map((tag) => ({ tag })) },
  ...
  await prisma.task.create({
    data: {
      ...
      requiredTags: { create: ["IT", "Tier1"].map((tag) => ({ tag })) },
      location: "New York",
      durationDays: 2,
    },
  });
  ...
  await prisma.task.create({
    data: {
      ...
      status: TaskStatus.PENDING,
      requiredTags: { create: ["Plumbing"].map((tag) => ({ tag })) },
      location: "Chicago",
      durationDays: 3,
    },
  });
  ...
  await prisma.task.create({
    data: {
      ...
      status: TaskStatus.PENDING,
      requiredTags: { create: ["Electrical", "Tier2", "IT"].map((tag) => ({ tag })) },
      location: "Austin",
      durationDays: 4,
    },
  });
  ...
  await prisma.task.create({
    data: {
      ...
      requiredTags: { create: ["IT", "Support"].map((tag) => ({ tag })) },
      location: "Austin",
      durationDays: 1,
    },
  });
  ...
  const branch3 = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.PENDING,
      requiredTags: { create: ["Management"].map((tag) => ({ tag })) },
      location: "New York",
      durationDays: 1,
    },
  });
  const branch2 = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.PENDING,
      requiredTags: { create: ["IT"].map((tag) => ({ tag })) },
      location: "New York",
      durationDays: 1,
